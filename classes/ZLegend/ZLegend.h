// @(#)root/graf:$Id: ZLegend.h 26711 2008-12-06 19:50:17Z brun $
...
//////////////////////////////////////////////////////////////////////////
//                                                                      //
// ZLegend        (a second attempt- the first was TPadLegend           //
...
class ZLegend : public TPave , public TAttText {

protected:
  ZLegend& operator=(const ZLegend&);

public:
  ZLegend();
  ZLegend( Double_t x1, Double_t y1, Double_t x2, Double_t y2,
	   const char* header = "", Option_t* option="brNDC" );
  virtual ~ZLegend();
  ZLegend( const ZLegend &legend );

  TLegendEntry   *AddEntry(const TObject* obj, const char* label = "", Option_t* option = "lpf" );
  TLegendEntry   *AddEntry(const char *name, const char* label = "", Option_t* option = "lpf" );

  ////////////////////////////////////////////////////
  // Custom AddEntry() function to color entry text //
  ////////////////////////////////////////////////////
  TLegendEntry   *AddEntry(const TObject* obj, Int_t textColor, const char* label = "", Option_t* option = "lpf");
...
protected:
  TList     *fPrimitives;       // list of ZLegendEntries
  ...
  ClassDef(ZLegend,2) // Legend of markers/lines/boxes to represent obj's
};
